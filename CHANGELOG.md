...
### Changed
- Icon-only retry button in job listing
...
## [v0.0.1](https://github.com/deivide/laravel-failed-jobs/releases/tag/v0.0.1) - 2026-03-16

### Added
- Retry button for failed jobs in listing page and detail page
...
* Works and functional (original package)
